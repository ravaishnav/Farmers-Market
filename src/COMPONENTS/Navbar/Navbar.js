        ...
        <nav>
                ...
                <div className='right'>
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item href="/Farmerlogin">Farmer Login</Dropdown.Item>
                            <Dropdown.Item href="/signup">Signup</Dropdown.Item>
                            <Dropdown.Item href="/Farmersignup">Farmer Signup</Dropdown.Item>
                            <Dropdown.Item href="/user/accountsettings">Profile</Dropdown.Item>
                            <Dropdown.Item href="/logout">Logout</Dropdown.Item>
                            <Dropdown.Item href="/Farmerlogout">Farmer Logout</Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
                </div>
            </div>
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item href="#/action-1">House Cleaning</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Dairy Products</Dropdown.Item>
                        <Dropdown.Item href="#/action-3">Fresh vegetables</Dropdown.Item>
                        <Dropdown.Item href="#/action-4">More products</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Link to='/about'>
                    <a>About Us</a>
                ...
                shows3 ?
                    <div className='s3'>
                        ...
                        <ul className='s32'>
                            ...
                            <li> <Link to='/FarmerLogin' className='stylenone'>
                                <a>FarmerLogin</a>
                            </Link></li>
                            <li> 
                                <Link to='/FarmerLogout' className='stylenone'>
                                <a>FarmerLogout</a>
                            </Link></li>
                            <li> 
                                <Link to='/FarmerSignup' className='stylenone'>
                                <a>FarmerSignup</a>
                            </Link></li>
